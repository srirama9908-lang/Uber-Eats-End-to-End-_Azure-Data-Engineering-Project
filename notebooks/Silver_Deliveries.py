...
df_deliveries = (
    spark.read
    .format("json")
    .load("abfss://bronze@ubereaststorage.dfs.core.windows.net/api/deliveries/")
)
...
df_deliveries_table.write.format("delta").mode("overwrite").saveAsTable("ubereats_databricks1.silver.silver_deliveries")